...
std::vector<bi::address> HostUtil::getInterfaceAddresses()
{
...
int HostUtil::listen4(bi::tcp::acceptor& _acceptor, unsigned short _listenPort)
{
	int retport = -1;
...
bi::tcp::endpoint HostUtil::traverseNAT(std::vector<bi::address> const& _ifAddresses, unsigned short _listenPort, bi::address& o_upnpifaddr)
{
